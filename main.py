...
plt.ylabel(r'$\sqrt{MSE}$', fontsize=22)
plt.title(r'$\sqrt{MSE}$ vs Number of Observations for k parameters', fontsize=20)
...
plt.xlabel("Number of Observations", fontsize=22)
plt.ylabel(r'$\sqrt{MSE}$', fontsize=22)
plt.title(r'$\sqrt{MSE}$ vs Number of Observations for $\alpha$ parameters', fontsize=20)
plt.legend(fontsize=20)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.grid(True)
...
plt.xlabel("Number of Observations", fontsize=22)
plt.ylabel(r'$\sqrt{MSE}$', fontsize=22)
plt.title(r'$\sqrt{MSE}$ vs Number of Observations for b parameters', fontsize=20)
plt.legend(fontsize=20)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.grid(True)
...
standard_dev_vec = np.linspace(np.sqrt(0.01), np.sqrt(0.1), 100)
